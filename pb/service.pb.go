...
var file_service_proto_rawDesc = []byte{
	...
	,
...
var file_service_proto_depIdxs = []int32{
	0, // 0: CalcService.Sum:input_type -> Request
	0, // 1: CalcService.Multiply:input_type -> Request
	1, // 2: CalcService.Sum:output_type -> Response
	1, // 3: CalcService.Multiply:output_type -> Response
...
func (c *calcServiceClient) Sum(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/CalcService/Sum", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *calcServiceClient) Multiply(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/CalcService/Multiply", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedCalcServiceServer) Sum(context.Context, *Request) (*Response, error) {
...
func _CalcService_Sum_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/CalcService/Sum",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalcServiceServer).Sum(ctx, req.(*Request))
	}
...
func _CalcService_Multiply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/CalcService/Multiply",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
